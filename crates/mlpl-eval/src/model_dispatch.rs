...
/// through the model and return argmax over the trailing
/// axis as integer class labels. Used by the trained ViT
/// demos to compare predictions against ground truth.
