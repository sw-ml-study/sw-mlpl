...
- chore(agentrail): begin 055-cnn-phase3-multiaxis-named-reduce
- docs(changes): refresh CHANGES.md to HEAD
...
- docs(changes): refresh CHANGES.md to HEAD
- chore(agentrail): complete 051-cnn-conv-live-demo; queue org-cnn-literate-math
- chore(pages): rebuild for Convolution-from-the-equation demo
- feat(demos): "Convolution from the equation" live demo
- docs(changes): refresh CHANGES.md to HEAD
...
- docs(changes): refresh CHANGES.md to HEAD
- chore(agentrail): complete 008-mlpl-fmt-reflow; queue du-list-fs
- feat(emacs): reflow one-line MLPL into indented multi-line (format-buffer + script)
- docs(changes): refresh CHANGES.md to HEAD
- chore(agentrail): complete 007-mlpl-mode-menu-bar (menu + init file); queue du-list-fs
- feat(emacs): add mlpl-init-example.el one-file setup (fixes stale-keymap)
- feat(emacs): add built-in easy-menu MLPL menu-bar to mlpl-mode
- docs(changes): refresh CHANGES.md to HEAD
...
- docs(extensions): B3 dynamic-load design (dlopen a cdylib provider)
...
- docs(changes): refresh CHANGES.md to HEAD
- chore(agentrail): complete 004-ui-host-launch-inversion; queue 005-provider-abi-and-contract
- feat(extensions): 'parked main' applet launch inversion (B6)
- docs(changes): refresh CHANGES.md to HEAD
...
- fix(web): render the demo Next-Steps epilogue as its own panel (demo-next-steps-block step 1)
- docs(changes): refresh CHANGES.md to HEAD
