    ...
    for i in 0..len {
        ...
        let new_value = match kind {
            ...
            | NodeKind::Stack { .. } => {
                ...
                // take, and stack are pure re-arrangements -- no
                // fp-rounding work happens inside them. The CPU
                // forward value is bitwise-identical to what an
                // MLX rerun would produce, so reuse it directly
