<!-- Generated by Proact for: Unknown at: 2026-04-04 11:25:43 -->
# AI Coding Agent Development Process Guidelines

This document provides explicit guidelines to be proactively followed by AI coding agents (Claude Code, opencode, Codex, etc.) during development tasks. Adherence ensures consistency, quality, maintainability, and continual improvement in codebases.
